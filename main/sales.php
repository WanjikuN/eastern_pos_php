...
<input type="hidden" name="cashier" value="<?php echo  $_SESSION['SESS_USER_NAME'] ; ?>" />
...
<option></option>
	...
	$result = $db->prepare("SELECT * FROM products");
		...
		if($availableqty <= 10 AND $availableqty>0){
	?>
		<option style="background:red;" value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Expires at: <?php echo $row['expiry_date']; ?>| Quantity left: <?php
		 echo $row['qty']; ?></option>
	<?php
		}elseif($availableqty >10){
			?>
			<option  value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Expires at: <?php echo $row['expiry_date']; ?>| Quantity left: <?php
			 echo $row['qty']; ?></option>
		<?php
		}
	else{
...
<?php 
?>
<a rel="facebox" href="checkout.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $_SESSION['SESS_USER_NAME']?>"><button class="btn btn-success btn-large btn-block"><i class="icon icon-save icon-large"></i> SAVE</button></a>
