...
<input type="text" size="25" value="" name="cname" id="country" onkeyup="suggest(this.value);" onblur="fill();" class="" autocomplete="off" placeholder="Enter Customer Name" style="width: 268px; height:30px;" />
	  ...
	  <!-- <select name="ptype" id="" style="width: 268px; height:30px;  margin-bottom: 15px;"  required>
...
// if($asas=='mpesa') {
?>
<!-- <input type="text" name="mpesa" placeholder="M-pesa" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/><br> -->
<?php
// }
if($asas=='cash') {
?>
